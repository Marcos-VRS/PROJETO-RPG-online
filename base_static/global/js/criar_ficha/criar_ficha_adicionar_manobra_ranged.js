            ...
            <div class="manobra-ataque-ranged-id">
                <div class="col-manobra">
                    <label for="nome_manobra_Ranged_id" class="label-nome-manobra medievalsharp-mini">Nome da
                        manobra</label>
                    <input class="campo-curto-nome medievalsharp-mini" name="nome_manobra_Ranged[]" placeholder="Nome da manobra" maxlength="30" type="text" />
                </div>
                <div>
                    <label for="manobra_damage_Ranged_id" class="medievalsharp-mini">Dano:</label>
                    <input class="campo-curto-equip medievalsharp-mini" name="damage_manobra_Ranged[]" placeholder="Damage" maxlength="12" type="text">
                    <label for="manobra_nh_Ranged_id" class="medievalsharp-mini">NH:</label>
                    <input class="campo-curto-equip medievalsharp-mini" name="nh_manobra_Ranged[]" placeholder="NH" maxlength="12" type="text">
                </div>
                <div>
                    ...
                    <textarea class="campo-curto-detalhes-manobra medievalsharp-mini"
                        ...
                        name="detalhes_manobra_Ranged[]" maxlength="1000"></textarea>
